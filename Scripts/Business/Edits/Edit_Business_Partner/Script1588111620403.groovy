...
//String createBusinessPartner = "jQuery('a[href*=\"/Management/BusinessPartner/Edit?entityCode=2a4f5276-30be-4677-9185-08d7f0f6bdfe\"]')[0].click()"
WebUI.delay(5)
...
WebUI.callTestCase(findTestCase('Validates_Edits'), [('test') : 'Socio de Negocios', ('seachvalue') : partnerName, ('table') : '#tablePrner', ('buttonnext') : '#tablePrner_next'],
