...
WebUI.delay(20)
//Si existe la tabla
String existe = "let elemento= (jQuery('#tableUser').length > 0); return elemento;"
...
if (elemento_existe == true)
{
	...
	if (validacion == '1')
	{
		WebUI.comment('Automatización Exitosa: Usuario Creado visible en pagina 1')
	}
	else if (validacion == '2')
	{
		WebUI.comment('Automatización Exitosa: Usuario Creado visible en pagina ${pagina_validacion}')
	}
	else if (validacion == '3')
	{
		WebUI.comment('Automatización Fallida: Usuario no encontrado en el Index')
	}
	
}
else{
	
	WebUI.comment('Automatización Fallida: Usuario No fue guardado')
}
