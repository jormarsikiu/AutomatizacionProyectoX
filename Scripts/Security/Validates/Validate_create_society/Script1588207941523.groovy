...
if (validacion == '1')
{
	WebUI.comment('Automatización Exitosa: Sociedad Creada visible en la pagina 1')
}
else if (validacion == '2')
{
	
	WebUI.comment('Automatización Exitosa: Sociedad Creada visible en la pagina ${pagina_validacion} ') 
}
else if (validacion == '3')
{
	WebUI.comment('Automatización Fallida: Sociedad No Creada No visible en el Index')
}
