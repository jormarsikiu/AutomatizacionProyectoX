...
if (tabla_existe == true)
{
	...
	if (validacion == '1')
	{
		WebUI.comment('Automatización Exitosa: '+tipo+' editado en pagina 1')
	}
	else if (validacion == '2')
	{
		WebUI.comment('Automatización Exitosa: '+tipo+' editado en pagina ' +pagina_validacion)
	}
	...
	WebUI.comment('Automatización Fallida:  '+tipo+' No fue editado')
}